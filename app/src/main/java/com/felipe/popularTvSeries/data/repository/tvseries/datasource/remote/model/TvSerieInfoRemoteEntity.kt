...
import com.felipe.popularTvSeries.data.common.TransformToDomainException
import com.felipe.popularTvSeries.domain.tvseries.model.TvSerieInfo
import com.google.gson.annotations.SerializedName

class TvSerieInfoRemoteEntity(
  ...
  fun transformToDomain() =
    ...
    else throw TransformToDomainException(this.javaClass.name)
